...
th {
  ...
  color: white;
    ...
    <body>
        ...
        <div class="row" style="text-align: center;"> <p style="color:white; font-size:  18px;">You are connected to the Project 3 Enterprise System database as a <i style="color: red;">root-level</i> user.</p></div>        
